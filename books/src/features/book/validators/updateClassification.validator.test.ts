import { UpdateClassificationValidator } from './updateClassification.validator';

describe('UpdateClassificationValidator', () => {
  describe('Valid inputs', () => {
    it('should pass validation with only Dewey Decimal', () => {
      const dto = {
        deweyDecimal: '813.6',
      };
      const { error } = UpdateClassificationValidator.validate(dto);
    ...
    it('should pass validation with null to clear Dewey Decimal', () => {
      const dto = {
        deweyDecimal: null,
        libraryOfCongressNumber: 'PZ7.R79835',
      };
    ...
    it('should pass validation with null to clear Library of Congress number', () => {
      const dto = {
        deweyDecimal: '813.6',
    ...
    it('should pass validation with null to clear OCLC number', () => {
      const dto = {
        deweyDecimal: '813.6',
        oclcNumber: null,
      };
    ...
    it('should pass validation with all fields null to clear classification', () => {
      const dto = {
        deweyDecimal: null,
        libraryOfCongressNumber: null,
        oclcNumber: null,
  ...
  describe('Required fields validation', () => {
    it('should fail when no fields are provided', () => {
      const dto = {};
      const { error } = UpdateClassificationValidator.validate(dto);
      expect(error?.details[0].message).toBe('At least one classification field must be provided');
    });
  });
